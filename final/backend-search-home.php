...
inner join Batting b ON m.playerID = b.playerID
    WHERE CONCAT(nameFirst, ' ', nameLast) LIKE ? LIMIT 5";
            ...
            if(mysqli_num_rows($result) > 0){
             ...
             Hitters: </p>';
                ...
                while($row = mysqli_fetch_array($result, MYSQLI_ASSOC)){
                    echo "<p>" .'<a href="final/id_search.php?playerID='.$row["playerID"].'">'.$row["Name"]."</a></p>";
                }
            } else{
            ...
            if(mysqli_num_rows($result2) > 0){
              ...
              Pitchers: </p>';
                ...
                while($row2 = mysqli_fetch_array($result2, MYSQLI_ASSOC)){
                    echo "<p>" .'<a href="final/id_search-pitcher.php?playerID='.$row2["playerID"].'">'.$row2["Name"]."</a></p>";
                }
            } else{
                echo "<p>No matches found</p>";
            }
